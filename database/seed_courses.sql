-- ============================================================
-- BQL ALGO — SEED COMPLET (59 leçons, 6 niveaux)
...
(course_bases_id,    'NIVEAU 1 : Bases de l''algorithmique', 'Variables, types, opérateurs, constantes, chaînes et entrée / sortie.', 1, 1, 'AlignLeft'),
(course_logic_id,    'NIVEAU 2 : Conditions',                'SI, SINON, SINON SI, SELON et opérateurs logiques avancés.', 2, 2, 'Shuffle'),
(course_loops_id,    'NIVEAU 3 : Boucles',                   'POUR, TANTQUE, REPETER, compteurs, recherche et validation.', 3, 3, 'RefreshCcw'),
(course_arrays_id,   'NIVEAU 4 : Tableaux (1D)',             'Déclaration, parcours, somme, max, recherche et tri à bulles.', 4, 4, 'Layers'),
(course_matrices_id, 'NIVEAU 5 : Matrices (2D)',             'Tableaux 2D, parcours, diagonale, sommes, symétrie et transposée.', 5, 5, 'Box'),
(course_structs_id,  'NIVEAU 6 : Enregistrements',           'TYPE ENREGISTREMENT, tableaux de structs et structures complexes.', 6, 6, 'Zap');

-- ======================================================================
-- NIVEAU 1 : BASES (10 leçons)
-- ======================================================================
INSERT INTO public.lessons (course_id, title, content, example_code, exercise, solution, expected_output, lesson_type, xp_value, "order") VALUES
...
FIN',
 NULL, NULL, NULL, 'operateurs', 25, 4),
...
FIN',
 NULL, NULL, NULL, 'constantes', 30, 6),
...
DEBUT
  ...
  ECRIRE("(a + b) * c = ", (a + b) * c);
FIN',
 NULL, NULL, NULL, 'expressions', 30, 7),
...
FIN',
 NULL, NULL, NULL, 'exemples', 25, 9),

-- 10. Exercice Niveau 1
(course_bases_id,
...
DEBUT
  ...
  FINSI
FIN',
 NULL, NULL, NULL, 'condition_si', 25, 1),
...
DEBUT
  ...
  FINSI
FIN',
 NULL, NULL, NULL, 'condition_sinon', 25, 2),

-- 3. SINON SI
(course_logic_id,
 'Conditions en chaîne (SINON SI)',
 'SINON SI permet d''enchaîner plusieurs conditions. BQL évalue chaque condition dans l''ordre et exécute le premier bloc vrai trouvé. Placez les conditions du plus restrictif au plus général.',
 'ALGORITHME_SinonSi;
VARIABLE
  temp : ENTIER;
DEBUT
  ...
  SI temp > 30 ALORS
    ECRIRE("Tres chaud");
  SINON SI temp > 20 ALORS
    ECRIRE("Agreable");
  SINON SI temp > 10 ALORS
    ECRIRE("Frais");
  SINON
    ECRIRE("Froid");
  FINSI
FIN',
 NULL, NULL, NULL, 'sinon_si', 25, 3),
...
DEBUT
  ...
  FINSI
FIN',
 NULL, NULL, NULL, 'condition_imbrique', 25, 4),
...
DEBUT
  ...
  FINSI
FIN',
 NULL, NULL, NULL, 'operateurs_logiques', 35, 5),
...
DEBUT
  ...
  FINSELON
FIN',
 NULL, NULL, NULL, 'selon_imbrique', 30, 7),
...
DEBUT
  ...
  SINON SI note >= 10 ET absences > 3 ALORS
    ECRIRE("Admis mais trop absent — avertissement");
  SINON SI (note >= 10) OU (projet >= 18) ALORS
    ECRIRE("Admis grace au projet");
  SINON
    ECRIRE("Recale");
  FINSI
FIN',
 NULL, NULL, NULL, 'conditions_combinees', 35, 8),

-- 9. Plages de valeurs (NOUVEAU)
(course_logic_id,
 'Plages de valeurs — notes et catégories',
 'Quand on teste des plages de valeurs (0–9, 10–12, 13–15, 16–20), SINON SI en cascade est le bon outil. SELON ne convient que pour des valeurs exactes, pas pour des intervalles. La règle d''or : du plus restrictif au plus général.',
...
DEBUT
  ...
  SINON SI bmi < 25.0 ALORS
    ECRIRE("Poids normal");
  SINON SI bmi < 30.0 ALORS
    ECRIRE("Surpoids");
  SINON
    ECRIRE("Obesite");
  FINSI
FIN',
 NULL, NULL, NULL, 'selon_plage', 35, 9),
...
DEBUT
  ...
  FINPOUR
FIN',
 NULL, NULL, NULL, 'boucle_intro', 25, 1),

-- 2. Boucle POUR
(course_loops_id,
 'Boucle POUR — itérations fixes',
 'La boucle POUR est utilisée quand on connaît à l''avance le nombre d''itérations. La variable de boucle est automatiquement incrémentée de 1 à chaque tour. La syntaxe est : POUR variable DE debut A fin FAIRE ... FINPOUR.',
...
DEBUT
  ...
  FINPOUR
FIN',
 NULL, NULL, NULL, 'boucle_pour', 25, 2),
...
DEBUT
  ...
  ECRIRE("Decollage !");
FIN',
 NULL, NULL, NULL, 'boucle_pour_pas', 30, 3),
...
DEBUT
  ...
  FINTANTQUE
FIN',
 NULL, NULL, NULL, 'boucle_tantque', 25, 4),

-- 5. REPETER JUSQU'A
(course_loops_id,
 'Boucle REPETER JUSQU''À — condition après',
 'La boucle REPETER s''exécute AU MOINS UNE FOIS car la condition est vérifiée APRÈS l''exécution du bloc. Elle s''arrête quand la condition devient VRAIE — logique inverse de TANTQUE.',
 'ALGORITHME_Repeter;
VARIABLE
  x : ENTIER;
DEBUT
  ...
  JUSQU''A x > 3;
FIN',
 NULL, NULL, NULL, 'boucle_repeter', 25, 5),
...
FIN',
 NULL, NULL, NULL, 'boucle_compteur', 35, 6),
...
DEBUT
  ...
  FINPOUR
FIN',
 NULL, NULL, NULL, 'boucle_imbrique', 30, 7),
...
DEBUT
  ...
  FINSI
FIN',
 NULL, NULL, NULL, 'boucle_recherche', 35, 8),
...
FIN',
 NULL, NULL, NULL, 'boucle_validation', 35, 9),
...
DEBUT
  n <- 1;
  // Écrire une boucle TANTQUE qui affiche 1, 2, 3
FIN',
...
DEBUT
  ...
  FINPOUR
FIN',
 NULL, NULL, NULL, 'tableau_init', 30, 2),
...
DEBUT
  ...
  FINPOUR
FIN',
 NULL, NULL, NULL, 'tableau_parcours', 25, 3),
...
DEBUT
  ...
  FINSI
FIN',
 NULL, NULL, NULL, 'tableau_somme', 35, 4),
...
FIN',
 NULL, NULL, NULL, 'tableau_max_min', 35, 5),
...
DEBUT
  ...
  FINSI
FIN',
 NULL, NULL, NULL, 'tableau_recherche', 35, 6),
...
DEBUT
  ...
  FINPOUR
FIN',
 NULL, NULL, NULL, 'tableau_insertion', 30, 7),
...
DEBUT
  ...
  FINPOUR
FIN',
 NULL, NULL, NULL, 'tableau_copie', 35, 8),
...
DEBUT
  ...
  FINPOUR
FIN',
 NULL, NULL, NULL, 'tableau_tri', 40, 9),
...
DEBUT
  ...
  FINPOUR
FIN',
 NULL, NULL, NULL, 'tableau_inverse', 40, 10),
...
DEBUT
  ...
  FINPOUR
FIN',
 NULL, NULL, NULL, 'tableau_decalage', 40, 11),
...
DEBUT
  ...
  FINPOUR
FIN',
 NULL, NULL, NULL, 'matrice_init', 30, 2),
...
DEBUT
  ...
  FINPOUR
FIN',
 NULL, NULL, NULL, 'matrice_parcours', 25, 3),
...
FIN',
 NULL, NULL, NULL, 'matrice_somme', 35, 4),
...
FIN',
 NULL, NULL, NULL, 'matrice_diagonale', 35, 5),
...
FIN',
 NULL, NULL, NULL, 'matrice_ligne_col', 35, 6),
...
FIN',
 NULL, NULL, NULL, 'matrice_max', 40, 7),
...
DEBUT
  ...
  FINSI
FIN',
 NULL, NULL, NULL, 'matrice_symetrie', 40, 8),
...
DEBUT
  ...
  FINPOUR
FIN',
 NULL, NULL, NULL, 'matrice_transposee', 45, 9),
...
FIN',
 NULL, NULL, NULL, 'matrice_inverse', 45, 10),
...
DEBUT
  ...
  FINPOUR
FIN',
 NULL, NULL, NULL, 'matrice_decalage', 45, 11),
...
DEBUT
  ...
  FINSI
FIN',
 NULL, NULL, NULL, 'struct_champs', 30, 2),
...
FIN',
 NULL, NULL, NULL, 'struct_modification', 30, 3),
...
DEBUT
  ...
  FINSI
FIN',
 NULL, NULL, NULL, 'struct_affichage', 30, 4),
...
DEBUT
  ...
  POUR i DE 0 A 3 FAIRE
    ...
    SINON SI classe[i].note >= 14 ALORS
      classe[i].mention <- "Bien";
    SINON SI classe[i].note >= 12 ALORS
      classe[i].mention <- "Assez bien";
    SINON SI classe[i].note >= 10 ALORS
  ...
  FINPOUR
FIN',
 NULL, NULL, NULL, 'struct_tableau', 40, 5),
...
FIN',
 NULL, NULL, NULL, 'struct_recherche', 40, 6),
...
DEBUT
  ...
  SINON SI aire2 > aire1 ALORS
    ECRIRE("R2 a la plus grande aire");
  SINON
    ECRIRE("Meme aire !");
  FINSI
FIN',
 NULL, NULL, NULL, 'struct_comparaison', 40, 7),
...
FIN', NULL, NULL, 'struct_complexe', 45, 8),
...
SET lesson_type = 'challenge',
    ...
    test_cases = '{"mode": "semantic_check", "required_keywords": ["CONSTANTE", "LIRE", "ECRIRE"], "cases": [{"input": "100\n2", "output": "240"}, {"input": "50\n1", "output": "60"}]}'::jsonb
...
SET lesson_type = 'challenge',
    ...
    test_cases = '{"mode": "semantic_check", "required_keywords": ["SELON", "CAS", "SI", "SINON", "LIRE"], "cases": [{"input": "120\n1", "output": "100"}, {"input": "50\n1", "output": "45"}, {"input": "200\n2", "output": "200"}, {"input": "100\n5", "output": "Erreur\n100"}]}'::jsonb
...
SET lesson_type = 'challenge',
    ...
    test_cases = '{"mode": "semantic_check", "required_keywords": ["POUR", "LIRE", "ECRIRE", "SI"], "cases": [{"input": "3\n10\n-5\n20", "output": "Invalide\n30"}, {"input": "2\n15\n15", "output": "30"}]}'::jsonb
WHERE title = 'EXERCICE : Valider le Niveau 3';

UPDATE public.lessons
SET lesson_type = 'challenge',
    title = 'Défi Final : Évaluation de Classe',
    ...
    test_cases = '{"mode": "semantic_check", "required_keywords": ["TABLEAU", "POUR", "LIRE", "SI", "ECRIRE"], "cases": [{"input": "8\n12\n15", "output": "15\n2"}, {"input": "5\n9\n20", "output": "20\n1"}]}'::jsonb
...
SET lesson_type = 'challenge',
    ...
    test_cases = '{"mode": "semantic_check", "required_keywords": ["POUR", "LIRE", "ECRIRE"], "cases": [{"input": "0\n10\n5\n20", "output": "35"}, {"input": "0\n0\n0\n0", "output": "0"}]}'::jsonb
...
SET lesson_type = 'challenge',
    ...
    test_cases = '{"mode": "semantic_check", "required_keywords": ["TYPE", "ENREGISTREMENT", "LIRE", "SI", "ECRIRE"], "cases": [{"input": "Faker\n12500\nShowmaker\n11200", "output": "Faker"}, {"input": "P1\n8000\nP2\n9500", "output": "P2"}]}'::jsonb

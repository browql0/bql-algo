  ...
  return (
    <>
      ...
      <div className="social-login-grid">
        ...
        <button type="button" className="social-btn" disabled onClick={() => handleSocialLogin('github')}>
          <svg className="social-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <form className="auth-form" onSubmit={handleSignUp} noValidate>
        ...
        <label className="terms-checkbox">
          ...
          <span className="terms-text">
            J'accepte les <Link to="/terms" className="auth-link">conditions d'utilisation</Link> et la { }
